...
async def on_message(message: DeliveredMessage):
    ...
    # Имитируем выполнение тяжелой CPU-бонд задачи
    time.sleep(body.get('delay'))  # type:ignore
...
async def main():
    ...
    # Создаем бесконечный цикл для ожидание сообщений для консьюмера из очереди
